...
| **Apache CloudStack** | Improved test robustness by skipping `QemuImgTest` when native libvirt cannot be loaded. | [PR #13086](https://github.com/apache/cloudstack/pull/13086) |
